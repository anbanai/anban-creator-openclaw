...
**设计方法论（字体/色彩/构图/信息层级/移动端，达到高级设计师水平）** → [references/design-principles.md](references/design-principles.md)：设定 `$STYLE` 与逐张构图时按需加载，把设计原则翻译成 prompt 的具体字号/字色/构图描述。**类目×平台差异**（服饰/3C/食品/美妆/家居）见 `ecommerce-platform-specs/references/category-specs.md`。
