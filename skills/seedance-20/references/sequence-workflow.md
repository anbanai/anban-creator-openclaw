...
## Anban Sequence Contract

Maintain `project-state.json` as the Project State Capsule. It contains accepted observed state, extension_depth, completed beats, reserved future beats, and prompt compiler inputs. Use Retake Protocol choices: Keep, Fix in post, Edit, don't regenerate, Re-roll, Rewrite. Never let rejected footage become canon.
